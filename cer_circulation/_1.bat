...
$base_file_key = "C:\Users\123\windows\cer_circulation\socks.txt.key"
$base_file_crt = "C:\Users\123\windows\cer_circulation\socks.txt.crt"

# Каталог в котором будут находятся итоговые файлы
$Folder_dst = "C:\Users\123\windows\cer_circulation\out"
